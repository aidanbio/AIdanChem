...
if __name__ == "__main__":
    ...
    # Load data
    train_data = pd.read_csv("/home/jin/Lim/Aidan/AR/admet_ai/output/22prop_reg_300k/train.csv")
    val_data = pd.read_csv("/home/jin/Lim/Aidan/AR/admet_ai/output/22prop_reg_300k/val.csv")
